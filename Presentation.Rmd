...
stargazer(OLSViolentFoundations, OLSViolentFlow, OLSViolentTurnout,
          ...
          title = "Regression analysis regarding violent crimes and three independent variable 
          with OLS regression (controls suppressed)",
          digits = 2,
...
stargazer(OLSMurderFoundations, OLSMurderFlow, OLSMurderTurnout, 
          ...
          keep = c("FoundationsDensity100k", "FlowRate", "TurnoutPercentage"),
          header = FALSE, # important not to have stargazer information in markdown file 
          title = "Regression analysis regarding murder and three independent variable 
          with OLS regression (controls suppressed)",
          digits = 2,
#          no.space = TRUE, # single.row = TRUE
          omit.stat = c("f", "ser"))
...
stargazer(nb.glm1, nb.glm2, nb.glm3, 
          ...
          header = FALSE, # important not to have stargazer information in markdown file 
          title = "Regression analysis regarding murder and three independent variable 
          with negative binominal regression (controls suppressed)",
          digits = 2,
#          no.space = TRUE, # single.row = TRUE
          omit.stat = c("f", "ser"))
```
...
stargazer(poisson.glm1, poisson.glm2, poisson.glm3, 
          ...
          header = FALSE, # important not to have stargazer information in markdown file 
          title = "Regression analysis regarding murder and three independent variable 
          with Poisson regression (controls suppressed)",
          digits = 2,
#          no.space = TRUE, # single.row = TRUE
          omit.stat = c("f", "ser"))
```
