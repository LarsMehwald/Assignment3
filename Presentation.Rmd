...
## Data
```{r Histogram Violent Crime, echo=FALSE, results='asis',warning=FALSE, message=FALSE}
source("Analysis/Graphs.R")
...
```{r plotOLSViolent, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
...
stargazer(OLSViolentFoundations, OLSViolentFlow, OLSViolentTurnout,
          ...
          title = "OLS regression analysis (controls suppressed)",
          dep.var.labels = "Violent crime",
          covariate.labels = "Foundations Density", "Flow Rate", "Election turnout",
          digits = 2,
...
stargazer(nb.glm1, nb.glm2, nb.glm3, 
          type = "html",
          keep = c("FoundationsDensity100kLog", "FlowRateLog", "TurnoutPercentageLog"),
          header = FALSE, # important not to have stargazer information in markdown file 
...
```{r TabMurderRateNegB, echo=FALSE, results='asis', warning=FALSE, message=FALSE}

source("Analysis/DataAnalysis.R")

stargazer(nb.glm5, nb.glm6, nb.glm7, nb.glm3,
          type = "html",
          header = FALSE, # important not to have stargazer information in markdown file 
...
stargazer(poisson.glm1, poisson.glm2, poisson.glm3, 
          type = "html",
          keep = c("FoundationsDensity100kLog", "FlowRateLog", "TurnoutPercentageLog"),
          header = FALSE, # important not to have stargazer information in markdown file 
