...
```{r PredProbTurnout, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
...
```{r PredProbFlow, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
...
```{r PredProbYouth, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
...
```{r PredProbMale, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
...
```{r PredProbMarriage, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
