...
We raise the question about how does social capital in a community determine the level of violent crime. Our results are not conclusive, but they showed a positive correlation between levels of unemployment and levels of crime. They also showed a relation between more heterogenous districts greater number of murders. However, these results failed to confirm a significant relation between measures of social capital and violent crimes, mainly due to methodological difficulties related to data access and available information on crime statistics.
