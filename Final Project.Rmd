...
```{r LoadingRfiles, echo=FALSE, warning=FALSE, message=FALSE, cache=TRUE}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Crime and the disruption it brings to the communities are one of the main determinants of individual weelbeing. Therefore, we are interested in responding to the question: how do social capital in a given community determine the level of violent crime? 
...
Here should be some interpretation of the regression results `r round(coef(OLSViolent)[2], digits=2)`. Here should be some interpretation of the regression results. Here should be some interpretation of the regression results. Here should be some interpretation of the regression results. Here should be some interpretation of the regression results. Here should be some interpretation of the regression results. 
...
Here should be some interpretation of the regression results. Here should be some interpretation of the regression results. Here should be some interpretation of the regression results. Here should be some interpretation of the regression results. Here should be some interpretation of the regression results. Here should be some interpretation of the regression results. 
