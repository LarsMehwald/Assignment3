...
```{r MapDt, fig.cap="Murder rate by district in Germany 2013", echo=FALSE, warning=FALSE, message=FALSE, fig.width=20, fig.height=20, results='asis'}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The OLS regression results for the dependent variable murder display some similarities for both specification models 3 and 4. However the the great difference for the control variable male percentage is another indication besides the methodological assumptions that a different model needs to be applied.  
