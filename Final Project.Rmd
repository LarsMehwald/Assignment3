...
We raise the question about how does social capital in a given community determine the level of violent crime higher unemployment is associated with higher levels of crime, and there are (on average) fewer murders occuring in the area of former East Germany. More heterogenous districts tend to be confronted with (on average) a greater number of murders. These results failed to prove a significant relation between social capital and crimes, due to methodological difficulties related to data access and available information on crime statistics.Relevance, Research Question, Main Findings
