...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;In our case, we could only find a stable link for the PKS statistics. All the other data sets by the Statistical Offices of the Laender had session IDs included into the link to the respective data sets. This prevented us from gathering the data dynamically. Therefore we downloaded the data sets manually and consequentially used them for statistical analyses. The data provided by the German Federal Foundations Association is contained in a PDF file on their web page. We needed to download this file, extract the data manually to an excel spreadsheet and then process it into the statistical analysis.  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The required socio economic data for all 402 German districts is publiclly available through the Regional Database Germany and it is published by the Federal Statistical Office and the statistical Offices of the Federal States (*Länder*)
