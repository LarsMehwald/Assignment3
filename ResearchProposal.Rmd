...
### Dependent Variable
Crime statistics were obtained from the German Federal Police's crime statistic ("Polizeiliche Kriminalstatistik" PKS) for only one year 2013 on a district level ("Kreis"). The first limitation we encounter was that the PKS is not providing 
...
For this research, we have conducted a cross-district study to estimate the relation of different indicators of social capital --engagment in the community, political participation and community stability-- and the incidence of violent and non-violent crime. 
